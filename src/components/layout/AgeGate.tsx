  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-lg text-center">
        <div className="mb-8 flex justify-center gap-6 font-display text-2xl text-gold-500/40" aria-hidden="true">
          <span>♠</span>
          <span className="text-[var(--ruby-bright)]/50">♥</span>
          <span className="text-[var(--ruby-bright)]/50">♦</span>
          <span>♣</span>
        </div>
        <p className="label mb-8">
          {site.address.building} &middot; {site.address.city}
        </p>
        ...
        <p className="lede mx-auto mt-7 max-w-sm">
          {site.name} is a licensed gaming venue. You must be 18 or over to enter, and
          you&rsquo;ll be asked for photo ID at the door.
        </p>
        <div className="mt-10 flex flex-wrap justify-center gap-3">
          <button onClick={accept} className="btn btn-solid">
