...
/** Location card + framed map for Casino Marina. */
            ...
            <div className="relative grid items-center gap-8 px-6 py-10 sm:px-10 sm:py-12 lg:grid-cols-[auto_1fr_auto]">
              <div>
                ...
                <p className="mt-2 font-display text-[clamp(3rem,8vw,5.5rem)] leading-none text-gold-200">
                  Marine<span className="text-[0.45em] text-gold-500"> Dr</span>
                </p>
        ...
        <div className="grid gap-14 lg:grid-cols-2 lg:gap-20">
          <div>
            <SectionHeading
              ...
              title="Casino Marina,"
              gold="Marine Drive."
              body="Find Diamond Lounge inside Casino Marina on Marine Drive in Colombo 03. Contact a host ahead of your visit for arrival details."
            />
