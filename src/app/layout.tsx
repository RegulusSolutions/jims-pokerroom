...
export const metadata: Metadata = {
  ...
  title: {
    default: `${site.name} — Poker in Sri Lanka`,
    template: `%s — ${site.name}`,
  },
  description: site.description,
  keywords: ["poker in Sri Lanka", "Jim's Poker Room", 'best poker room in Sri Lanka', "Texas Hold'em Colombo", 'Lotus Tower casino'],
  openGraph: {
    type: 'website',
    locale: 'en_US',
    siteName: site.name,
    title: `${site.name} — Poker in Sri Lanka`,
    description: site.description,
    url: site.url,
  },
