...
export const events: PokerEvent[] = [
  ...
  },
  {
    ...
    dateLabel: 'Running 24 hours',
    buyIn: 'From LKR 10,000',
    stack: '100 big blinds recommended',
    format: "Hold'em · PLO5 · Roulette · Andar Bahar · Blackjack · Baccarat · Niu Niu",
    blurb:
      'Cash tables run around the clock with the full mix — Hold\'em, PLO5, Roulette, Andar Bahar, Blackjack, Baccarat and Niu Niu. Call ahead and we will hold a seat at the stake you want.',
